...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        zh: {
            ...
            navMisc: '其他',
            heroGreeting: '你好，我是 👋',
            heroTagline: '清华大学本科生 @ <span class="highlight">Tsinghua University</span><br>关注 <span class="highlight">CAD 几何建模 | 工业软件</span>',
            heroBio: '清华大学笃实书院本科生，IISE/DAIS 会员，软件工程、航空航天工程与工业工程交叉背景。对工程软件与 CAD 相关方向保持长期兴趣，目前重点夯实 C / C++ / Python 与数据结构算法基础，并在数值计算与工程软件环境配置方面持续实践。',
        ...
        en: {
            ...
            heroBio: 'Undergraduate at Tsinghua University and member of IISE/DAIS, with interdisciplinary training in software engineering, aerospace engineering, and industrial engineering. I keep long-term interests in engineering software and CAD, and I am currently strengthening C/C++/Python and data structures & algorithms while practicing numerical computing and engineering software environment setup.',
